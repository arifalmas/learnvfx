  ...
  return (
    <header className="fixed md:top-2 left-0 right-0 z-50 transition-all duration-300">
      <div className="w-full md:max-w-7xl mx-auto lg:px-4 ">
        <nav className={`relative backdrop-blur-xl bg-black border border-white/20 shadow-xl rounded-2xl ${!isOpen ? "rounded-none lg:rounded-lg" : "rounded-none lg:rounded-lg lg:rounded-bl-lg rounded-br-none lg:rounded-br-lg"}  py-1`}>
