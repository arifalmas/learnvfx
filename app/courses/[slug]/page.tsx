...
export default function SoundPackPage() {
  ...
  const confirmUnlock = () => {
    ...
    // এখানে future এ API / crystal deduct logic যাবে
  };
    ...
    <>
      <section className="min-h-screen bg-[#0d0f12] text-white pb-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mt-10">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div
                  className="w-16 h-16 rounded-lg overflow-hidden border border-white/10 bg-[#14161b]">
                  <img src="/finalsfx.png" alt="sound pack thumbnail"
              ...
              <div className="rounded-2xl overflow-hidden border border-white/10">
                <img src="/images/folder-preview.png" alt="organized folders"
                  className="w-full" />
              </div>
            </div>

            {/* RIGHT CARD */}
            <Card className="h-fit bg-gray-50/5 border border-white/10 p-6">
          ...
          {/*===== PREVIEW, DRAG AND DROP SECTION ===== */}
          <Card className="mt-16 md:w-[65%] bg-gray-50/5 border border-white/10 p-6">
            ...
            <Image src="/images/audio-preview.png" alt="audio preview" className="w-full"
            ...
            <CardTitle className="text-xl font-semibold mb-4 text-white mt-10  md:mt-16">
              Drag and drop the segment you like              </CardTitle>
            <img src="/images/drag-drop.png" alt="drag and drop" className="w-full" width={800} height={400} />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-[#1a1c20] rounded-2xl w-full max-w-2xl p-8 border border-white/10">
            <h2 className="text-center text-lg text-gray-300 mb-6">
              spent <span className="text-white font-semibold">36 crystal</span> to unlock
              this
              pack?
            </h2>

            <div
              className="flex items-center gap-4 bg-[#101213] rounded-xl p-4 mb-8 border border-white/10">
              <img src="/finalsfx.png" className="w-16 h-16 rounded-lg object-cover"
                alt="pack" />

              <div>
                <h3 className="font-semibold">
                  20,000+ Sound Effects Pack{" "}
                  <span className="text-xs text-gray-400">YesRealSabbir</span>
                </h3>
